...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
      AD_WO_L,  BLE_DIS,   BLE_EN,   USB_DIS,    USB_EN,   DELBNDS,           AD_WO_L,  BLE_DIS,   BLE_EN,   USB_DIS,    USB_EN,   DELBNDS, \
      DEL_ID0, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_RCTL, \
      ADV_ID0,  ADV_ID1,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
      MO(_LOWER), KC_LGUI,  LT(_RAISE,KC_BSPC),                               LT(_RAISE,KC_ENT), KC_SPC, MO(_LOWER) \
      ),
  ...
  [_COLEMAK] = LAYOUT( \
      ...
      ADJUST, EISU,    LOWER,                                                 RAISE,   KANA,   KC_RGHT \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    EISU,             KANA, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, _______, \
      ADJUST, EISU,    LOWER,                                                 RAISE,   KANA,   KC_RGHT \
      ),
